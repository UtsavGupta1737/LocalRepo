...
# initialisation
	def __init__(self):
		...
		# support surface
		self.support_surf = pygame.Surface((WINDOW_WIDTH, WINDOW_HEIGHT))
...
# input
	...
	def selection_hotkeys(self,event):
		if event.type == pygame.KEYDOWN:
			if event.key == pygame.K_RIGHT and self.selection_index < 18 :
				self.selection_index += 1
			if event.key == pygame.K_LEFT and self.selection_index > 2 :
				self.selection_index -= 1
